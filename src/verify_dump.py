...
def getType(binary):
    ...
    jType = ["000010", "000011"]
    loadType = ["100011", "100001","100101", "100000", "100100"]
    storeType = ["101011", "101001", "101000"]
    ...
    if opcode in iType:
        ...
        return "J"
    elif opcode in loadType:
        return "L"
    elif opcode in storeType:
        return "S"  
...
def getClocks(binary):
    if getType(binary) == "I":
        ...
        return 3
    elif getType(binary) == "L":
        return 5
    elif getType(binary) == "S":
        return 4
...
###############################
    ...
    totalCycles = sum(clocks for _, clocks in binaryAndClocks)
